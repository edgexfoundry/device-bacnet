...
public class ProfileStore {
	...
	// profile
	// object key
	private Map<String, Map<String, BACNetObject>> objects = new HashMap<>();
	
	public Map<String, Map<String, BACNetObject>> getObjects() {
		return objects;
	}
	...
	public void addDevice(Device device) {
		...
		Map<String, BACNetObject> deviceObjects = new HashMap<>();
		for (DeviceObject object: device.getProfile().getDeviceResources()) {
			BACNetObject BACNetObject = new BACNetObject(object);
			
			PropertyValue value = object.getProperties().getValue();
			
			deviceObjects.put(object.getName(), BACNetObject);
